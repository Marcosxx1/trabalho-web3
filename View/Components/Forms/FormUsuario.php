...
<form action="<?php echo APP; ?>usuario/salvar" method="post">
    <input type="hidden" class="form-control" id="id" value="<?php echo $usuario['id']; ?>" name="id">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="numero_casa" value="<?php echo $usuario['numero_casa']; ?>"
            name="numero_casa">
    </div>
